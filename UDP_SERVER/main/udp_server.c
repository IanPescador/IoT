...
//UDP SERVER CONFIG
static void udp_server_config_task(void *pvParameters)
{
    char rx_buffer[128];
    char message[128];
    char addr_str[128];
...
void app_main(void)
{
    ...
    if (config_complete){
        ...
        //Server UDP
        xTaskCreate(udp_server_config_task, "udp_server", 4096, (void*)AF_INET, 5, NULL);
    }
}